...
export function Avatar(props) {
  const { nodes, materials, scene } = useGLTF("/models/moi.glb");
  ...
  const [animation, setAnimation] = useState(animations.find((a) => a.name === "happy_idle") ? "happy_idle" : animations[0].name);
  useEffect(() => {
...
useGLTF.preload("/models/moi.glb");
